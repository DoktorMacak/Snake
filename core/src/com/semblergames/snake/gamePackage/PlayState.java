    ...
    public void touchUp(int x, int y) {
        ...
        if(playing){
            ...
            if (Math.abs(dx) > Math.abs(dy)){
                if(snake.getDirection() != Direction.right && snake.getDirection() != Direction.left && Math.abs(dx) > 15*main.SCALEX) {
                ...
                if (snake.getDirection() != Direction.up && snake.getDirection() != Direction.down && Math.abs(dy) > 15*main.SCALEY) {
